...
This repository contains my three completed projects for the DecodeLabs
...
- [x] All three projects present in a single repository
...
- [x] Code runs without errors (hardcoded absolute path in Project 2 fixed to a relative path; all three pipelines re-tested end-to-end after consolidation)
